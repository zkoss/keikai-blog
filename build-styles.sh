...
npx lessc --math=always less/keikaifonts.css blog/css/keikaifonts.min.css --clean-css

mkdir -p blog/css/lato
cp -r less/lato/* blog/css/lato
npx lessc --math=always less/lato/latofonts.css blog/css/lato/latofonts.min.css --clean-css
